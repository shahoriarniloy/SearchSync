        ...
        <div className=" mx-auto mb-0 h-fit " >
            ...
            {user ? (
                        ...
                        <div>
                            ...
                            <div className="flex l justify-center items-center "> 
                                <button onClick={handleGoogleSignIn} className="btn bg-white lg:mr-4 md:mr-4"><img className="w-12 h-auto" src="https://i.ibb.co/tzD10YQ/6929234-google-logo-icon.png" alt="" style={{ width: "32px", height: "32px" }} />Google</button>
                            </div>
                        </div>
                    )}
                    ...
                    <Link to="/signup"><button className="btn btn-primary  text-white w-60 mb-8">Create New Account</button></Link>
